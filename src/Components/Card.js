...
const Card = ({ content}) => {
    return(
        <Link to={`/product/${content.cca3}`} className="block rounded-lg overflow-hidden shadow-xl hover:shadow-2xl hover:scale-110 transition-all dark:bg-darkG bg-whiteN">
