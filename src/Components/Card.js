...
const Card = ({ content}) => {
    return(
        <Link to={`/country/${content.cca3}`} className="block rounded-lg overflow-hidden shadow-xl hover:shadow-2xl hover:scale-110 transition-all dark:bg-darkG bg-whiteN">
                ...
                <div className="px-6 py-8 text-left text-black dark:text-whiteN">
                    ...
                    <p><b>Population:</b> {content.population.toLocaleString("en-US")}</p>
