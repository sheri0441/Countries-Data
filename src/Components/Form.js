    ...
    <div className="mt-9 flex flex-col md:flex-row md:justify-between">
      <div className="md:w-1/2">
        <label className="shadow-md rounded-md px-7 py-6 w-full relative block bg-whiteN dark:bg-darkG ">
          ...
          <input
            className="absolute top-2/4 -translate-y-1/2 right-0 w-[calc(100%-36px)] pointer-events-none placeholder:text-VDGrayBG dark:placeholder:text-whiteN focus:outline-none bg-whiteN dark:bg-darkG text-black dark:text-whiteN pl-1"
      ...
      <div className="bg-whiteN mt-4 md:mt-0 px-6 dark:bg-darkG shadow-md rounded-md max-w-fit">
        <select
          className="pr-2 w-fit focus:outline-none py-3  bg-whiteN dark:bg-darkG text-black dark:text-whiteN border-none outline-none"
